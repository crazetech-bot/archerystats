    ...
    <div class="flex-1 flex flex-col min-h-screen bg-white">
        <div class="flex-1 flex items-center justify-center px-6 py-12 sm:px-10">
            <div class="w-full max-w-sm">
                ...
                {{-- Success --}}
                @if(session('status'))
                    <div class="mb-5 flex items-start gap-3 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 fade-1">
                        <svg class="h-5 w-5 text-emerald-500 flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
